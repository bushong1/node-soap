...
Client.prototype.setDefaultNamespace = function(defaultNamespace) {
  this.defaultNamespace = defaultNamespace;
}

Client.prototype.addSoapHeader = function(soapHeader, name, namespace, xmlns, defaultNamespace) {
  if (!this.soapHeaders) {
    this.soapHeaders = [];
  }
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  xml = "<soap:Envelope ";
  if(defaultNamespace) {
    console.log("Adding default namespace: "+defaultNamespace);
    xml += "xmlns=\""+defaultNamespace+"\" ";
  } else {
    console.log("No default namespace provided");
  }
